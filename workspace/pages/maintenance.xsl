...
<xsl:template name="maint">
  <xsl:comment><![CDATA[[if lt IE 7]> <html class="no-js ie6 oldie" lang="en" /> <![endif]]]></xsl:comment>
    ...
    <head>
      ...
      <link rel="stylesheet" href="{$root}/workspace/assets/css/maint.css"/>
    </head>
    <body>
      <div class="logo">
        <img src="http://atheycreek.com/workspace/assets/img/apple-touch-icon.png" height="300px" width="300px" />
      </div>
