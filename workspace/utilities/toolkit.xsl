			...
			<table border="1" style="border-collapse: collapse; width: 100%; border-color: #ededec; border: 1px solid #ededec;">
				<xsl:for-each select="/data/images-toolkit-all-entries-filtered/entry">
					<tr>
						...
						<td style="padding: 10px">
							<input value='&lt;img data-responsimage="{image/filename}" width="100%" class="img-responsive" data-responsimage-anchor="5" src="/workspace/assets/img/spacer.gif" /&gt;' style="width: 550px; font-size: 13px" onclick="this.select()" />
...
<xsl:template name="image-background">
...
<xsl:template name="image-background-css">
	...
	<xsl:text>/0/uploads/images/</xsl:text>
